            ...
            <Slider {...settings}>
                <div className="BigSlider1">
                    ...
                    <div className='btns position-absolute'>
                        ...
                        <a href="https://kaspi.kz/shop/search/?text=%D1%82%D0%B5%D1%80%D1%80%D0%B8%D1%82%D0%BE%D1%80%D0%B8%D1%8F%20%D1%81%D0%BD%D0%B0&at=1&page=1"
                ...
                <div className="BigSlider2">
                    ...
                    <div className='btns position-absolute'>
                        <a className='btn btn-lg btn-warning fw-semibold'>Заказать матрас</a>
                    </div>
                </div>
                <div className="BigSlider3 text-white ml-5">
                    <img src="BigSlider3.1.jpg" alt="" />
                    <div class="text d-block ms-5">
                ...
                <div className='BigSlider4'>
                    ...
                    <div className='text d-flex flex-column justify-content-center align-items-center'>
                        ...
                        <a className='btn mx-auto btn-lg btn-warning fw-semibold' onClick={() => alert()}>Заказать матрас</a>
                    </div>
                </div>
            </Slider>
        </div>
